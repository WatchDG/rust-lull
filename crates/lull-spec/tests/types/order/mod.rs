...
fn equal_fields_are_equal_orders() {
    assert_eq!(
        order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-1", 100),
        order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-1", 100)
    );
}
...
fn distinct_ids_are_not_equal_orders() {
    assert_ne!(
        order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-1", 100),
        order("ord-2", OrderSide::Buy, OrderType::Limit, "inst-1", 100)
    );
}
...
fn distinct_sides_are_not_equal_orders() {
    assert_ne!(
        order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-1", 100),
        order("ord-1", OrderSide::Sell, OrderType::Limit, "inst-1", 100)
    );
}
...
fn distinct_types_are_not_equal_orders() {
    assert_ne!(
        order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-1", 100),
        order("ord-1", OrderSide::Buy, OrderType::Market, "inst-1", 100)
    );
}
...
fn distinct_instruments_are_not_equal_orders() {
    assert_ne!(
        order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-1", 100),
        order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-2", 100)
    );
}
...
fn distinct_sizes_are_not_equal_orders() {
    assert_ne!(
        order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-1", 100),
        order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-1", 101)
    );
}

#[test]
fn clone_preserves_equality() {
    let order = order("ord-1", OrderSide::Buy, OrderType::Limit, "inst-1", 100);
