...
fn equal_instruments_are_equal() {
    let left: TestCandlestickInstrument =
        CandlestickInstrument::new(InstrumentRef::Id(InstrumentId::new(String::from("inst-1"))));
    let right: TestCandlestickInstrument =
        CandlestickInstrument::new(InstrumentRef::Id(InstrumentId::new(String::from("inst-1"))));
...
fn distinct_instruments_are_not_equal() {
    let left: TestCandlestickInstrument =
        CandlestickInstrument::new(InstrumentRef::Id(InstrumentId::new(String::from("inst-1"))));
    let right: TestCandlestickInstrument =
        CandlestickInstrument::new(InstrumentRef::Id(InstrumentId::new(String::from("inst-2"))));
    assert_ne!(left, right);
}

#[test]
fn clone_preserves_equality() {
    let instrument: TestCandlestickInstrument =
        CandlestickInstrument::new(InstrumentRef::Id(InstrumentId::new(String::from("inst-1"))));
